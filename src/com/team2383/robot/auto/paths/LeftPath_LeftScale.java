...
public class LeftPath_LeftScale extends CommandGroup {
	...
	Waypoint[] secondCubePoints = new Waypoint[] {
			...
			new Waypoint(19, 27 - 7.2, Pathfinder.d2r(180 + 15)),
			};
	
	Waypoint[] backToScalePoints = new Waypoint[] {
			new Waypoint(19, 27 - 7.2, Pathfinder.d2r(15)),
			new Waypoint(24, 27 - 7.6, Pathfinder.d2r(-19)),
			};
	
	Waypoint[] thirdCubePoints = new Waypoint[] {
			new Waypoint(24, 27 - 7.6, Pathfinder.d2r(180 - 19)),
			new Waypoint(17.8, 27 - 9.8, Pathfinder.d2r(180 + 45)),
			};
	
	Waypoint[] backToScale2Points = new Waypoint[] {
			new Waypoint(17.8, 27 - 9.8, Pathfinder.d2r(45)),
			new Waypoint(24, 27 - 7.8, Pathfinder.d2r(-20)),
			};
